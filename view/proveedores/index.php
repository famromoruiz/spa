...
$model = $this->modelProveedor->Listar($pagina);
 ?>
...
<a href="?r=proveedores/agregar" class="btn btn-seremas float-right" >
  Agregar
</a>
  </div>
</div>
    ...
    <?= Gridview::Gridview($model['lista'],
      [
        'etiquetas' => [
          ...
          'rfc' => ['nombre' => 'rfc'],
          'tel_1' => ['nombre' => 'telefono']
        ],
        'atributos' => array('nombre','rfc','tel_1'),
