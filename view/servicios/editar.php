		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<?php  echo $model->nombre == null ? 'Agregar Producto' : 'Actualizar: '.$model->tratamiento;  ?>
				</div>
				<div class="card-body">
						...
						<div class="col-md-6">
                    		...
                    		<p>
								<div class="form-group">
                    				...
                    				<input maxlength="100" type="text" hidden="" required="required" class="form-control" placeholder="id" name="id_servicio" value="<?= $model->id_servicio ?>"/>
                    			</div>
                    		</p>
							<p>
								<div class="form-group">
