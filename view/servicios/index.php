...
$model = $this->modelServicios->Listar_modelo($pagina);
 ?>
...
<a href="?r=servicios/agregar" class="btn btn-seremas float-right" >
  Agregar
</a>
  </div>
</div>
  ...
  <div class="table-responsive datos ">
    ...
    <?= Gridview::Gridview($model['lista'],
      [
        ...
        'atributos' => array('nombre','tratamiento','regular','tiempo'),
