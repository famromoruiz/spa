...
.container{
  ...
  <body class="text-center">
    ...
    <div class="container">
      ...
      <input type="password" id="password" name="password" class="form-control" placeholder="ingresa tu nueva contraseña" required autofocus>
      <hr>
      
      <button class="btn btn-lg btn-seremas btn-block" type="submit">Guardar</button>
